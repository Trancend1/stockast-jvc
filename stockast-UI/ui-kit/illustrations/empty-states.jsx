// empty-states.jsx — Illustrated empty states.
//
// Each export is a small SVG illustration + matching panel component.
// Style: ink-stamp consistent with OnbDecor / WarungMark / NotebookFold,
// always-warm palette so they feel like familiar marginalia rather
// than UI chrome.
//
//   · EmptyNoData       — "belum ada catatan"
//   · EmptyNoHistory    — "minggu pertama, sabar dulu"
//   · EmptyOffline      — "internet putus"
//   · EmptyError        — "ada yang ngambek"
//   · EmptySearch       — "nggak ada yang cocok"
//   · EmptyDone         — "udah beres semua" (celebratory)
...
function IllustNoData({ size = 140 }) {
  return (
    <svg viewBox="0 0 140 110" width={size} height={size * 110/140}
         xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
         style={{ display: "block" }}>
      {/* notebook with blank page + a small pen */}
      <g stroke={E_INK} strokeWidth="1.5" strokeLinejoin="round" strokeLinecap="round">
        ...
        {/* ruled lines, faded */}
        <path d="M 40 46 L 100 46 M 40 56 L 100 56 M 40 66 L 90 66 M 40 76 L 100 76 M 40 86 L 80 86"
              opacity="0.25" strokeWidth="1" />
      </g>
      {/* pen diagonal */}
...
function IllustNoHistory({ size = 140 }) {
  return (
    <svg viewBox="0 0 140 110" width={size} height={size * 110/140}
         xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
         style={{ display: "block" }}>
...
function IllustOffline({ size = 140 }) {
  return (
    <svg viewBox="0 0 140 110" width={size} height={size * 110/140}
         xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
         style={{ display: "block" }}>
      {/* unplugged cord — two ends + sparks */}
...
function IllustError({ size = 140 }) {
  return (
    <svg viewBox="0 0 140 110" width={size} height={size * 110/140}
         xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
         style={{ display: "block" }}>
      {/* tipped-over pot with ink spill */}
      <g stroke={E_INK} strokeWidth="1.7" strokeLinejoin="round" strokeLinecap="round">
        ...
        {/* spilled ink puddle */}
        <path d="M 30 92 q 14 -10 36 -6 q 22 6 44 -2 q 4 12 -4 14 L 30 98 Z"
              fill={E_INK} opacity="0.9" />
      </g>
      {/* small "!"" in brick */}
      <g transform="translate(106 28)">
        ...
        <text x="0" y="5" textAnchor="middle"
              ...
              fontWeight="800" fontSize="16" fill="#FFF">!</text>
      </g>
    </svg>
  );
}

function IllustSearch({ size = 140 }) {
  return (
    <svg viewBox="0 0 140 110" width={size} height={size * 110/140}
         xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
         style={{ display: "block" }}>
      {/* magnifying glass over empty grid */}
      ...
      <g transform="translate(70 56)">
        ...
        <text x="0" y="6" textAnchor="middle"
              ...
              fontSize="20" fontWeight="700" fill={E_INK}>?</text>
      </g>
...
function IllustDone({ size = 140 }) {
  return (
    <svg viewBox="0 0 140 110" width={size} height={size * 110/140}
         xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
         style={{ display: "block" }}>
      {/* big stamp circle with check */}
      ...
      <path d="M 58 54 L 66 64 L 84 46"
            fill="none" stroke={E_MINT} strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
...
// ─────────────── Panel component ───────────────
function EmptyPanel({ illust: Ill, title, body, cta }) {
  return (
    <div style={{
...
window.SkEmpty = {
  IllustNoData, IllustNoHistory, IllustOffline,
  IllustError, IllustSearch, IllustDone,
  EmptyPanel,
};
